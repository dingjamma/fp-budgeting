    ...
    return (
      <div className="container">
        ...
        <h1 className='text-center'> Registration / Login</h1>
            <Label htmlFor='btn'>
                <button id ='btn' className='btn-lg btn-dark btn-block'
                onClick={() => this.setState({ createAccount: !this.state.createAccount })}>{this.state.createAccount ? 'Log in to an existing account' : 'Create a new account'}</button>
            </Label>
            <br></br>
            <Label htmlFor='email'>
            ...
            <Label className="btn2">
                    <button id='btn2' className='btn-lg btn-dark btn-block' onClick={async () => {
                      try {
