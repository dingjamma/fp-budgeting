    ...
    return(
        <nav className="navbar navbar-expand-lg navbar-light bg-dark">
          <div className="container">
            <a className="nav-link text-white text-uppercase ml-5" href="#"> <i className="fas fa-file-invoice-dollar fa-3x"></i> <span className="sr-only">(current)</span></a>
                  ...
                  <ul className="navbar-nav ml-auto">
                   ...
                   <Link to="/">
                      <li className="nav-item active">
                         <a className="nav-link text-white text-uppercase ml-5" href="#">  <i className="fas fa-home"></i> <span className="sr-only">(current)</span></a>
                      </li>
                    </Link>
